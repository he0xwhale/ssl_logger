# # Refer to :
# 1. https://github.com/google/ssl_logger/blob/master/ssl_logger.py
# 2. https://github.com/fanxs-t/Android-SSL_read-write-Hook/blob/master/frida-hook.py
...
_FRIDA_SCRIPT = """
   ...
   */
  var addresses={}
  var SSL_get_fd,SSL_get_session,SSL_SESSION_get_id,getpeername,getsockname,ntohs,ntohl
  ...
  // var ssl_read_address=Module.findExportByName("ssleay32.dll","SSL_read")
  // var ssl_write_address=Module.findExportByName("ssleay32.dll","SSL_write")
  // console.log("ssl_read_address:"+ssl_read_address)
  // console.log("ssl_write_address:"+ssl_write_address)
